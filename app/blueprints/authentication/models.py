...
class User(UserMixin, db.Model):
    ...
    # UserMixinMethods: #.get_id()
    # .is_anonymous = return True if session object doesn't have info stored in it
    # .is_authenticated = reutrn True if session object does have info stored in it
    # current_user
